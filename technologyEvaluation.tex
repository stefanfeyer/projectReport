...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{img/hmd.jpg}
	\caption{Valve Index}
	\label{fig:hmd}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.49\textwidth]{img/singleViveTracker.jpg}
	\includegraphics[width=0.49\textwidth]{img/trackerMount.jpg}
...
\begin{figure}
	\centering
	\includegraphics[width=0.49\textwidth]{img/box_evaluation.jpg}
	\includegraphics[width=0.49\textwidth]{img/box_table.jpg}
